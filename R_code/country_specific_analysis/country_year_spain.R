...
#Change COUNTRY
dati_2016$cat_es_2017 <- dati_2016$cat_2017
dati_2016$prob_es_2017 <- fitted_2016
variable <- c("id", "cat_es_2017", "prob_es_2017")
dati_es_2016 <- dati_2016[variable]

#Save Data
write_dta(dati_es_2016, "dati_es_2016.dta")
...
#Change COUNTRY
dati_2015$cat_es_2016 <- dati_2015$cat_2016
dati_2015$prob_es_2016 <- fitted_2015
variable <- c("id", "cat_es_2016", "prob_es_2016")
dati_es_2015 <- dati_2015[variable]

#Save Data
write_dta(dati_es_2015, "dati_es_2015.dta")
...
#Change COUNTRY
dati_2014$cat_es_2015 <- dati_2014$cat_2015
dati_2014$prob_es_2015 <- fitted_2014
variable <- c("id", "cat_es_2015", "prob_es_2015")
dati_es_2014 <- dati_2014[variable]

#Save Data
write_dta(dati_es_2014, "dati_es_2014.dta")
...
#Change COUNTRY
dati_2013$cat_es_2014 <- dati_2013$cat_2014
dati_2013$prob_es_2014 <- fitted_2013
variable <- c("id", "cat_es_2014", "prob_es_2014")
dati_es_2013 <- dati_2013[variable]

#Save Data
write_dta(dati_es_2013, "dati_es_2013.dta")

#FOR FRANCE - PORTUGAL - SPAIN STOP HERE
...
#Change COUNTRY
dati_2012$cat_es_2013 <- dati_2012$cat_2013
dati_2012$prob_es_2013 <- fitted_2012
variable <- c("id", "cat_es_2013", "prob_es_2013")
dati_es_2012 <- dati_2012[variable]

#Save Data
write_dta(dati_es_2012, "dati_es_2012.dta")
...
#Change COUNTRY
dati_2011$cat_es_2012 <- dati_2011$cat_2012
dati_2011$prob_es_2012 <- fitted_2011
variable <- c("id", "cat_es_2012", "prob_es_2012")
dati_es_2011 <- dati_2011[variable]

#Save Data
write_dta(dati_es_2011, "dati_es_2011.dta")
...
#Change COUNTRY
dati_2010$cat_es_2011 <- dati_2010$cat_2011
dati_2010$prob_es_2011 <- fitted_2010
variable <- c("id", "cat_es_2011", "prob_es_2011")
dati_es_2010 <- dati_2010[variable]

#Save Data
write_dta(dati_es_2010, "dati_es_2010.dta")
...
#Change COUNTRY
dati_2009$cat_es_2010 <- dati_2009$cat_2010
dati_2009$prob_es_2010 <- fitted_2009
variable <- c("id", "cat_es_2010", "prob_es_2010")
dati_es_2009 <- dati_2009[variable]

#Save Data
write_dta(dati_es_2009, "dati_es_2009.dta")
...
predictors <- c("iso", "tfp_acf_2008", "dummy_patents", "dummy_trademark", "consdummy", "control", 
                ...
                "fin_expenses_2008", "net_income_2008",  "fin_cons100_2008" , "inv_2008" , "real_SA_2008", 
...
#Change COUNTRY
dati_2008$cat_es_2009 <- dati_2008$cat_2009
dati_2008$prob_es_2009 <- fitted_2008
variable <- c("id", "cat_es_2009", "prob_es_2009")
dati_es_2008 <- dati_2008[variable]

#Save Data
write_dta(dati_es_2008, "dati_es_2008.dta")
