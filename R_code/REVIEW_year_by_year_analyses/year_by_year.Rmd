...
# Missingness patterns between firms in liquidations and other failed firms
...
# Plot missingness patterns over years
gg_miss_fct(prova_2[2:length(prova_2)], Year) + 
  labs(title = "Bankruptcies and dissolved firms", 
           x = "Years", 
           y = "Variables") +
  scale_x_discrete(limits = c(2008:2016)) +
  scale_fill_continuous(type = "viridis", name = "% Missing") + 
...
# Analysis for Italian Firms (2009-2017): failures without liquidations
...
Save data augment with default probabilities
```{r}
