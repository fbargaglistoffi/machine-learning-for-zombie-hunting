...
(Table 6): Compute the average transition (t --> t+1) across deciles over years 2015 - 2017 
```{r}
...
Run the following chucnk if you want to check how the number of zombies changes when you move the cutoff 
```{r eval=FALSE}
...
Compute the number of firms transited from a zombie status in t to: (I) Zombie, (II) Failure, (III) Lower distress region, (IV) No distress region in year t+1
```{r}
