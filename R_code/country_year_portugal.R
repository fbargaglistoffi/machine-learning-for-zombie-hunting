...
dati <- read_dta("data_portugal.dta")
...
#Change COUNTRY
dati_2016$cat_pt_2017 <- dati_2016$cat_2017
dati_2016$prob_pt_2017 <- fitted_2016
variable <- c("id", "cat_pt_2017", "prob_pt_2017")
dati_pt_2016 <- dati_2016[variable]

#Save Data
write_dta(dati_pt_2016, "dati_pt_2016.dta")
...
#Change COUNTRY
dati_2015$cat_pt_2016 <- dati_2015$cat_2016
dati_2015$prob_pt_2016 <- fitted_2015
variable <- c("id", "cat_pt_2016", "prob_pt_2016")
dati_pt_2015 <- dati_2015[variable]

#Save Data
write_dta(dati_pt_2015, "dati_pt_2015.dta")
...
#Change COUNTRY
dati_2014$cat_pt_2015 <- dati_2014$cat_2015
dati_2014$prob_pt_2015 <- fitted_2014
variable <- c("id", "cat_pt_2015", "prob_pt_2015")
dati_pt_2014 <- dati_2014[variable]

#Save Data
write_dta(dati_pt_2014, "dati_pt_2014.dta")
...
#Change COUNTRY
dati_2013$cat_pt_2014 <- dati_2013$cat_2014
dati_2013$prob_pt_2014 <- fitted_2013
variable <- c("id", "cat_pt_2014", "prob_pt_2014")
dati_pt_2013 <- dati_2013[variable]

#Save Data
write_dta(dati_pt_2013, "dati_pt_2013.dta")