...
missmap(raw_data_missing[sample_1000,],
...
```{r}
balanced_accuracy_logit<-balanced_accuracy(as.matrix(table(fitted.logit,
                                                             test$failure)))
...
```{r}
balanced_accuracy_ctree <- balanced_accuracy(as.matrix(table(fitted.ctree,
                                                            test$failure)))
...
```{r}
balanced_accuracy_rf <- balanced_accuracy(as.matrix(table(fitted.rf,
                                                      test$failure)))
...
```{r}
balanced_accuracy_sl <- balanced_accuracy(as.matrix(table(fitted.sl,
                                                      test$failure)))
